...
//  std::vector<int>::iterator it1 = final_ind_classes_size.end();
//  std::vector<std::vector<int> >::iterator it2 = class_counts_list.end();
//  int i = final_ind_classes_size.size();
//  while(i >= 0){
//    --it1;
//    --it2;
//    if(final_ind_classes_size[i-1] == 0) {
//      class_counts_list.erase(it2);
//      final_ind_classes_size.erase(it1);
//    }
//    --i;
//  }

//  std::vector<std::vector<int> > myresult;
//  std::vector<int> myresult_sizes;
//  for(int i=0; i<final_ind_classes_size.size(); ++i) {
//    if(final_ind_classes_size[i] != 0) {
//      myresult_sizes.push_back(final_ind_classes_size[i]);
//      myresult.push_back(class_counts_list[i]);
//    }
//  }
//  myresult.insert(myresult.begin(), myresult_sizes);
